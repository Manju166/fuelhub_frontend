...
function Consumer() {
  ...
  const handleUpdate = useEditConsumer(
    refetch,
    setIsModalOpen,
    setErrorMessage
  );
  ...
  return (
    <>
      ...
      <div className="consumer">
        <div className=""></div>
        <button
          className="table-container__add-customer-btn"
        ...
        {isModalOpen && (
          ...
          >
            ...
            {modalMode === "view" ? (
              <div>
                <p>
                  <strong>ID:</strong> {selectedConsumer?.id}
                </p>
                <p>
                  <strong>Name:</strong> {selectedConsumer?.name}
                </p>
                <p>
                  <strong>Address:</strong> {selectedConsumer?.address}
                </p>
                <p>
                  <strong>Email:</strong> {selectedConsumer?.email}
                </p>
                <p>
                  <strong>Phone no. :</strong> {selectedConsumer?.phoneNumber}
                </p>
              </div>
            ) : (
              <form>
                ...
                <div className="modal-footer">
                  {modalMode === "add" ? (
                    ...
                    <button
                      type="button"
                      onClick={() => handleUpdate(selectedConsumer, formData)}
                    >
                      Update
                    </button>
                  )}
