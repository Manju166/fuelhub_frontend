  ...
  return async (formData) => {
    ...
    try {
      const { data } = await createResource({
        variables: { resourceInput: { resourceStatus: formData.resourceStatus, resourceCategory: formData.resourceCategory } },
      });
  ...
  return async (selectedResource, formData) => {
    ...
    try {
      const { data } = await updateResource({
        variables: { id: selectedResource.id, resource: { resourceStatus: formData.resourceStatus, resourceCategory: formData.resourceCategory } },
      });
