    ...
    <div className={`main-content-container ${isDarkMode ? 'main-content--dark' : 'main-content--light'}`}>
     <div className='dashboard_container'>
        <div className='text-dash'>
          ...
          <ReactTyped strings={["Welcome to dashboard !!!","Welcome to FUELHUB !!!"]} typeSpeed={30} loop onComplete={handleTypingComplete} />
          </div>
          <div className="breadcrumb">
              <span><Link to='/'>Dashboard</Link></span> / <Link to='/consumer'><span >Consumer List</span> </Link>
            </div>
